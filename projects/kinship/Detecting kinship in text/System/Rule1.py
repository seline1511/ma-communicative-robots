...
def find_relation1(utterances, kinship_term, character_list):
    '''
...
def main1(data):
    ...
    for kinship_term, utterances in train_data.items():
        for utterance_set in utterances:
            ...
            source, relation, target = find_relation1(utterance_set, kinship_term, character_list)
            i+=1
...
#relations, utterances = main1("../Preprocessing/Preprocessed_html_data.pkl")
